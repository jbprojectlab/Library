...
export default function(state = initialState, action) {
  switch (action.type) {
    case ADD_NEW_CAT:
      return Object.assign({}, state, { cats: [...state.cats, action.cat] });
    case ADD_NEW_DOG:
      return Object.assign({}, state, { dogs: [...state.dogs, action.dog] });
    case ADOPT_PET:
      return Object.assign({}, state, { petToAdopt: action.pet });
    case PREVIEW_PET:
      return Object.assign({}, state, { petToPreview: action.pet });
    case REMOVE_CAT:
