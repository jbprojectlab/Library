...
deposit5.onclick = function () {
  return _store2.default.dispatch((0, _store.deposit)(5));
};
deposit25.onclick = function () {
  return _store2.default.dispatch((0, _store.deposit)(25));
};
withdraw5.onclick = function () {
  return _store2.default.dispatch((0, _store.withdraw)(5));
};
withdraw25.onclick = function () {
  return _store2.default.dispatch((0, _store.withdraw)(25));
};

var balanceField = document.getElementById("balance");
_store2.default.subscribe(function () {
  console.log("The store state changed. Here is the new state:", _store2.default.getState());
  balanceField.innerText = "$ " + _store2.default.getState().balance;
});
...
exports.deposit = exports.withdraw = undefined;
