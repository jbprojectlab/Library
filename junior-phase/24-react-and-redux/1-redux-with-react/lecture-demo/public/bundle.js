...
var Bank = function Bank(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "header",
      null,
      _react2.default.createElement("img", { src: "logo.svg", width: "150", alt: "ReduxBank" }),
...
var ConnectedBank = function (_Component) {
  _inherits(ConnectedBank, _Component);

  function ConnectedBank() {
    _classCallCheck(this, ConnectedBank);

    var _this = _possibleConstructorReturn(this, (ConnectedBank.__proto__ || Object.getPrototypeOf(ConnectedBank)).call(this));

    _this.state = {
      balance: _store2.default.getState().balance
    };
    return _this;
  }

  _createClass(ConnectedBank, [{
    ...
    value: function render() {
      return _react2.default.createElement(Bank, {
        balance: this.state.balance,
        deposit: function deposit(amount) {
          // trigger a change to the store (via dispatch)
          var depositAction = (0, _store.deposit)(amount);
          _store2.default.dispatch(depositAction);
        },
        withdraw: function withdraw(amount) {
          // trigger a change to the store (via dispatch)
          var withdrawAction = (0, _store.withdraw)(amount);
          _store2.default.dispatch(withdrawAction);
        } });
    }
  }]);
...
exports.withdraw = exports.deposit = undefined;
...
var deposit = exports.deposit = function deposit(amount) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(15), __webpack_require__(43)(module)))
