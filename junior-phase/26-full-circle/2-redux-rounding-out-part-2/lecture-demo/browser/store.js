...
const START_LOADING_SCORES = 'START_LOADING_SCORES'
...
const startLoadingScores = () => ({
  type: START_LOADING_SCORES
});
...
const scoresReducer = (scoresState = {data: [], isLoading: false}, action) => {
  switch (action.type) {
    case START_LOADING_SCORES:
      return {
        ...scoresState,
        isLoading: true
      };
