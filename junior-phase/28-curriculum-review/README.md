...
## Part I (setup and user list)

- [👾 Demo code](fullstack-demo-part-1)
- [📺 Demo recording](https://youtu.be/fIS6QpW_LEw)
- [📖 Q & A notes](fullstack-demo-part-1/q-and-a-notes.md)
- [📺 Q & A recording](https://youtu.be/NDaigxma1qc)

## Part II (single user, add user, remove user, edit user)

- [👾 Demo code](fullstack-demo-part-2)
